local AddOnName, Env = ...
local ADDON = LibStub("AceAddon-3.0"):NewAddon(AddOnName,'AceHook-3.0',"AceConsole-3.0","AceEvent-3.0",)
Env[1], _G[AddOnName] = ADDON, ADDON
ADDON.mediaPath = [[Interface\AddOns\]]..AddOnName..[[\media\]]
----[[ Dev Ini ]]--------------------------------------------------------------------------------------------------------------
ADDON.development = DiesalDevelopment and DiesalDevelopment.developmentTools or {}
