...
-- ~~| ConfigSpinner |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
local TYPE 		= 'ConfigSpinner'
local VERSION 	= 1
-- ~~| ConfigSpinner StyleSheets |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
local styleSheet = {
	['frame-background'] = {			
		type			= 'texture',
		layer			= 'BACKGROUND',								
...
-- ~~| ConfigSpinner Locals |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

-- ~~| ConfigSpinner Methods |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
local methods = {
	...
	['ApplySettings'] = function(self)
		...
		self.spinner:SetSettings({
			...
			max		= data.max 		or 100,
			step		= data.step 	or 5,
			width		= data.width and ADDON.Round(data.width,2)-1 or 45,			
		},true)			
...
local function Constructor()
	...
	name:SetPoint("TOPRIGHT",spinner.frame,'TOPLEFT',-4,-10)
	name:SetHeight(1)		
